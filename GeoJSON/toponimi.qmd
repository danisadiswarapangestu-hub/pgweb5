...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link size="" mimeType="" url="Server=gisserver_skala_250K; Service=sde:sqlserver:gisserver\skala_250K; Database=Indonesia_250K; Version=dbo.DEFAULT" description="" name="SDE Feature Class" type="ArcSDE Connection" format=""/>
  </links>
  <dates/>
  <fees></fees>
